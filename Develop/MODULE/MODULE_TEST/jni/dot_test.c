...
unsigned char row[36][8] ={
	...
	{0x44, 0x48, 0x50, 0x60, 0x50, 0x48, 0x44, 0x44},   //K		[20]
	...
	{0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x3C},   //U		[30]
...
unsigned int DOTTest(int dot_fd, int val){
...
/*	DOTTest(dot_fd, 32);	sleep(1);
	DOTTest(dot_fd, 24);	sleep(1);
	DOTTest(dot_fd, 24);	sleep(1);
	DOTTest(dot_fd, 20);	sleep(1);
	DOTTest(dot_fd, 10);	sleep(1);
*/
	return 0;
}
